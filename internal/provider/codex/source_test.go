...
// The app server is reaped through internal/exec's Child, never through the raw command.
//
...
func TestTheAppServerIsReapedThroughTheThingThatKnowsWhenItsPidStopsBeingIts(t *testing.T) {
